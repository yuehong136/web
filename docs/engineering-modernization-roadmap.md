...
| 2026-06-12 | 删除中央 `queryKeys` + `invalidateQueries` 帮助对象（lib/query-client.ts 164→31 行，只剩 QueryClient 配置）；删除前 grep 确认仅 App.tsx 导入 `queryClient` 本体                                                                                                                                                                                                                                                    | （待填） | ARCH-3 验收第 1 条达成                                                       |
