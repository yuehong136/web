...
const DocumentChunksPage: React.FC = () => {
  ...
  const handleStartMetaAnnotation = () => {
    ...
    const metaArray = Object.entries(currentMeta).map(
      ([key, value], index) => ({
        id: `meta_${index + 1}`,
        key,
        value,
  ...
  return (
    ...
    >
      <div className="flex min-h-0 flex-1 flex-col lg:flex-row">
        ...
        {/* 中间分段列表区域 */}
        <div className="flex min-h-0 flex-1 flex-col bg-background-surface">
          {/* ragflow 风格工具栏 */}
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <Segmented
                  value={textMode}
                  onValueChange={(val) =>
                    setTextMode(val as 'full' | 'ellipse')
                  }
                >
          ...
          <div className="flex min-h-0 flex-1 flex-col">
                  ...
                  {filteredChunks.map((chunk) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        {(() => {
                          const chunkType =
                            ((chunk as any).doc_type_kwd?.toLowerCase() as
                              | 'image'
                              | 'text'
                              | 'table') || 'text'
                          const getTypeStyles = () => {
                          ...
                          {chunk.img_id && (
                            <div
                              ...
                              style={{
                                minHeight: '64px',
                                minWidth:
                                  textMode === 'full' ? '120px' : '64px',
                                maxWidth:
                                  textMode === 'full' ? '160px' : '64px',
                              }}
                            >
                              <img
                                    ...
                                    {chunk.important_kwd.map(
                                      (keyword, index) => (
                                        <Tooltip key={index} content={keyword}>
                                          <span
                                            className="inline-flex max-w-24 items-center truncate rounded px-2 py-0.5 text-xs"
                                            style={{
                                              backgroundColor:
                            ...
                            {chunk.question_kwd &&
                              chunk.question_kwd.length > 0 && (
                                <div className="flex items-start gap-2">
                                  ...
                                  <div className="flex flex-wrap gap-1.5">
                                    {chunk.question_kwd.map(
                                      (question, index) => (
                                        <Tooltip key={index} content={question}>
                                          <span
                                            className="inline-flex max-w-32 items-center truncate rounded px-2 py-0.5 text-xs"
                                            style={{
                                              backgroundColor:
            ...
            {total > 0 && (
              <div
                className="sticky bottom-0 shadow-lg backdrop-blur-sm"
                style={{
                  borderTop:
                    '1px solid var(--color-components-pagination-border)',
                    ...
                    <div className="min-h-[200px]">
                      {isMarkdownPreview ? (
                        ...
                        <textarea
                          ...
                          onChange={(e) =>
                            setEditingChunkContent(e.target.value)
                          }
                      ...
                      <div className="space-y-3">
                        ...
                        {selectedChunk.img_id && editingImage.length === 0 && (
                          <div
                            ...
                            onClick={() =>
                              setPreviewImageUrl(
                                `${API_BASE_URL}/${API_VERSION}/document/image/${selectedChunk.img_id}`,
                              )
                            }
                            style={{
                              backgroundColor:
                        ...
                        <ImageUploader
                          ...
                          title={
                            selectedChunk.img_id ? '上传新图片替换' : undefined
                          }
                          description={
                            selectedChunk.img_id
                              ? 'PNG、JPG、WebP、GIF，最大 10MB'
                              : undefined
                          }
                          dropzoneHeight="h-36"
                        />
                        ...
                        >
                          {Object.keys(docInfo.meta_fields || {}).length > 0 ? (
                            <div className="space-y-1 text-xs">
                              {Object.entries(docInfo.meta_fields || {}).map(
                                ([key, value]) => (
                                  <div
                                    key={key}
                        ...
                        <div className="space-y-2 text-xs">
                          ...
                          <div className="flex justify-between">
                            ...
                            <span
                              style={{ color: 'var(--color-text-primary)' }}
                            >
                              {formatDate(docInfo.create_date)}
                            </span>
                          </div>
                          <div className="flex justify-between">
                            <span
                            ...
                            <span
                              style={{ color: 'var(--color-text-primary)' }}
                            >
                              {formatDate(docInfo.update_date)}
                            </span>
                          </div>
                          <div className="flex justify-between">
                            <span
                        ...
                        <div className="space-y-2 text-xs">
                          ...
                          <div className="flex items-center justify-between">
                            ...
                            <Button
                              ...
                              size="sm"
                              onClick={() =>
                                setShowParserConfig(!showParserConfig)
                              }
                          ...
                          {showParserConfig && docInfo.parser_config && (
                            ...
                            >
                              ...
                              <div className="space-y-2">
                                ...
                                {docInfo.parser_config.chunk_token_num !==
                                  undefined && (
                                  <div className="flex items-center justify-between">
                                    <span
                                      className="text-xs"
                                ...
                                {docInfo.parser_config.topn_tags !==
                                  undefined && (
                                  <div className="flex items-center justify-between">
                                    <span
                                      className="text-xs"
                                ...
                                {docInfo.parser_config.auto_keywords !==
                                  undefined && (
                                  <div className="flex items-center justify-between">
                                    <span
                                      className="text-xs"
                                ...
                                {docInfo.parser_config.auto_questions !==
                                  undefined && (
                                  <div className="flex items-center justify-between">
                                    <span
                                      className="text-xs"
                              ...
                              {docInfo.parser_config.raptor?.use_raptor && (
                                ...
                                >
                                  ...
                                  <div className="space-y-1.5 pl-3">
                                    {docInfo.parser_config.raptor.scope !==
                                      undefined && (
                                      <div className="flex justify-between">
                                        <span
                                          className="text-xs"
                                    ...
                                    {docInfo.parser_config.raptor.max_token !==
                                      undefined && (
                                      <div className="flex justify-between">
                                        <span
                                          className="text-xs"
                                    ...
                                    {docInfo.parser_config.raptor.threshold !==
                                      undefined && (
                                      <div className="flex justify-between">
                                        <span
                                          className="text-xs"
                              ...
                              {docInfo.parser_config.graphrag?.use_graphrag && (
                                ...
                                >
                                  ...
                                  <div className="space-y-1.5 pl-3">
                                    {docInfo.parser_config.graphrag.method !==
                                      undefined && (
                                      <div className="flex justify-between">
                                        <span
                                          className="text-xs"
                                        ...
                                        >
                                          {docInfo.parser_config.graphrag
                                            .method === 'light'
                                            ? '轻量级'
                                            : '标准'}
                                        </span>
                                      ...
                                      docInfo.parser_config.graphrag
                                        ...
                                        <div className="flex flex-col gap-1">
                                          ...
                                          <div className="flex flex-wrap gap-1">
                                            {docInfo.parser_config.graphrag.entity_types.map(
                ...
                <div className="grid flex-1 grid-cols-2 gap-3">
                  <div>
                    ...
                    <Input
                      value={item.key}
                      onChange={(e) =>
                        handleUpdateMetaKey(item.id, e.target.value)
                      }
                      placeholder="字段名..."
                      className="text-sm"
                    />
