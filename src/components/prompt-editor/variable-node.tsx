...
export class VariableNode extends DecoratorNode<ReactNode> {
  ...
  decorate(): ReactNode {
    let content: ReactNode = (
      <span className="text-text-accent">{this.__label}</span>
    )
    ...
    return (
      <div className="bg-surface-tertiary text-text-primary inline-flex items-center rounded-radius-md px-space-sm py-0">
        {content}
      </div>
    )
  }
