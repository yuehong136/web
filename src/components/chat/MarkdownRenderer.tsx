...
// 聊天消息是模型输出（不可信），markdown-it 开了 html:true，渲染结果必须经
// DOMPurify 净化。target/rel 不在默认白名单，显式保留以维持外链 _blank + noopener。
...
md.renderer.rules.heading_open = function (
  ...
  token.attrJoin(
    'class',
    styleClasses[level as keyof typeof styleClasses] || '',
  )
