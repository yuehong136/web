  ...
  return (
    <div className="my-3 space-y-2">
      ...
      {displayCalls.map((call, index) => {
        ...
        const toolName = isLegacyCall
          ? (call as any).tool_name
          : (call as any).name
          ...
          >
            ...
            >
              <CollapsibleTrigger asChild>
                <div
                  className="flex cursor-pointer items-center justify-between px-3 py-2.5 transition-colors hover:bg-[var(--color-surface-secondary)]"
                  style={{ color: 'var(--color-text-primary)' }}
                >
                ...
                >
                  ...
                  {error && (
                    <div className="space-y-1.5">
                      ...
                      <div
                        className="rounded-lg p-2.5 pl-4 font-mono text-sm"
                        style={{
                          background: 'var(--color-components-alert-error-bg)',
                          color: 'var(--color-components-alert-error-text)',
                          border:
                            '1px solid var(--color-components-alert-error-border)',
                        }}
                      >
                        {error}
                      </div>
