    ...
    <div className={cn('flex items-start gap-4', className)}>
      ...
      <div className="group relative">
        {!avatarBase64Str ? (
          ...
          <div
            className={cn(
              'bg-surface-secondary grid place-content-center rounded-lg border border-dashed border-border-default',
              disabled && 'opacity-50',
            )}
            style={{ width: size, height: size }}
          >
            <div className="pointer-events-none flex flex-col items-center gap-1 text-text-tertiary">
              {loading ? (
          ...
          >
            ...
            <div
              className={cn(
                'pointer-events-none absolute inset-0 rounded-lg bg-transparent',
                'transition-colors group-hover:bg-state-neutral-10',
              )}
            >
              <Pencil
                size={16}
          ...
          <div className="flex flex-col items-center py-4">
            {imageToCrop && (
              <div className="w-full">
                <div
                  ref={containerRef}
                  className="bg-surface-secondary relative mx-auto overflow-hidden rounded-lg border border-border-default"
                  style={{
                    width: '300px',
                    height: '300px',
                    touchAction: 'none',
                ...
                >
                  ...
                  {imageLoaded && (
                    <div
                      className="absolute cursor-move rounded-lg border-2 border-dashed border-white"
                      style={{
