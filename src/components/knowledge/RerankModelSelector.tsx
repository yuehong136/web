      ...
      <div className="space-y-2">
        ...
        <div className="relative">
          <div className="w-full px-3 py-2 border border-gray-300 rounded-md bg-gray-50 flex items-center h-8">
            ...
            <span className="ml-2 text-gray-500 text-xs">加载重排序模型中...</span>
          </div>
        </div>
      </div>
    )
  ...
  return (
    <div className="space-y-2" ref={dropdownRef}>
      <div className="flex items-center space-x-1 mb-1">
        ...
        <Tooltip content="可选。用于对初始检索结果进行重新排序，提高结果质量">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2 flex-1 min-w-0">
              {selectedModel ? (
                ...
                <div className="text-gray-500 text-xs">不使用重排序</div>
              )}
            </div>
            <ChevronDown 
              className={cn(
            ...
            <div 
              ...
              <button
                ...
                className={cn(
                  ...
                  selectedModelId === null && "bg-blue-50 border-blue-100"
                )}
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-2">
                    <div className="text-gray-900 font-medium">不使用重排序</div>
                  </div>
