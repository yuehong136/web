...
export const queryKeys = {
  ...
  knowledgeBases: {
    ...
    detail: (id: string) =>
      [...queryKeys.knowledgeBases.details(), id] as const,
    graph: (id: string) =>
      [...queryKeys.knowledgeBases.detail(id), 'graph'] as const,
  },
  ...
  mcpServers: {
    ...
    tools: (id: string) =>
      [...queryKeys.mcpServers.detail(id), 'tools'] as const,
  },
  ...
  workflows: {
    ...
    executions: (id: string) =>
      [...queryKeys.workflows.detail(id), 'executions'] as const,
  },
  ...
  stats: {
    ...
    usage: (timeRange: string) =>
      [...queryKeys.stats.all, 'usage', timeRange] as const,
  },
...
export const invalidateQueries = {
  ...
  dialogApps: () =>
    queryClient.invalidateQueries({ queryKey: queryKeys.dialogApps.all }),
