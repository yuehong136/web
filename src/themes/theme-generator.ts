...
export const lightTokens: DesignTokens = {
  ...
  // ===== 系统状态页面专用 =====
  'components-system-page-bg': 'linear-gradient(180deg, #f8fafc 0%, #f3f6fb 100%)',
  'components-system-panel-bg': 'rgba(255, 255, 255, 0.78)',
  'components-system-panel-border': 'rgba(148, 163, 184, 0.22)',
  'components-system-panel-shadow': '0 16px 40px -24px rgba(15, 23, 42, 0.35), 0 1px 2px rgba(15, 23, 42, 0.08)',
  'components-system-header-title': '#0f172a',
  'components-system-header-description': '#475569',
  'components-system-version-tag-bg': 'rgba(241, 245, 249, 0.85)',
  'components-system-version-tag-border': 'rgba(148, 163, 184, 0.3)',
  'components-system-version-tag-label': '#64748b',
  'components-system-version-tag-value': '#0f172a',
  'components-system-section-title': '#334155',
  'components-system-section-divider': 'rgba(148, 163, 184, 0.24)',
  'components-system-empty-bg': 'rgba(248, 250, 252, 0.9)',
  'components-system-empty-border': 'rgba(148, 163, 184, 0.25)',

  'components-system-health-ok-bg': 'rgba(16, 185, 129, 0.12)',
  'components-system-health-ok-border': 'rgba(16, 185, 129, 0.35)',
  'components-system-health-ok-text': '#047857',
  'components-system-health-warning-bg': 'rgba(245, 158, 11, 0.12)',
  'components-system-health-warning-border': 'rgba(245, 158, 11, 0.35)',
  'components-system-health-warning-text': '#b45309',
  'components-system-health-error-bg': 'rgba(239, 68, 68, 0.12)',
  'components-system-health-error-border': 'rgba(239, 68, 68, 0.32)',
  'components-system-health-error-text': '#b91c1c',

  'components-system-status-card-bg': 'rgba(255, 255, 255, 0.94)',
  'components-system-status-card-border': 'rgba(148, 163, 184, 0.24)',
  'components-system-status-card-border-hover': 'rgba(100, 116, 139, 0.45)',
  'components-system-status-card-shadow': '0 8px 24px -18px rgba(15, 23, 42, 0.35), 0 1px 2px rgba(15, 23, 42, 0.08)',
  'components-system-status-ok-bg': 'rgba(16, 185, 129, 0.12)',
  'components-system-status-ok-border': 'rgba(16, 185, 129, 0.35)',
  'components-system-status-ok-text': '#047857',
  'components-system-status-warning-bg': 'rgba(245, 158, 11, 0.12)',
  'components-system-status-warning-border': 'rgba(245, 158, 11, 0.35)',
  'components-system-status-warning-text': '#b45309',
  'components-system-status-error-bg': 'rgba(239, 68, 68, 0.12)',
  'components-system-status-error-border': 'rgba(239, 68, 68, 0.32)',
  'components-system-status-error-text': '#b91c1c',

  'components-system-chart-grid': 'rgba(148, 163, 184, 0.22)',
  'components-system-chart-axis': '#64748b',
  'components-system-chart-tooltip-bg': '#ffffff',
  'components-system-chart-tooltip-border': 'rgba(148, 163, 184, 0.28)',
  'components-system-chart-tooltip-text': '#0f172a',
  'components-system-chart-tooltip-muted': '#64748b',
  'components-system-chart-done': '#10b981',
  'components-system-chart-done-soft': 'rgba(16, 185, 129, 0.14)',
  'components-system-chart-failed': '#f43f5e',
  'components-system-chart-failed-soft': 'rgba(244, 63, 94, 0.14)',
  'components-system-chart-pending': '#f59e0b',
  'components-system-chart-pending-soft': 'rgba(245, 158, 11, 0.16)',
  'components-system-chart-lag': '#64748b',
  'components-system-chart-info-pill-bg': 'rgba(226, 232, 240, 0.7)',
  'components-system-chart-info-pill-text': '#475569',
}
...
export const darkTokens: DesignTokens = {
  ...
  // ===== 系统状态页面专用 =====
  'components-system-page-bg': 'linear-gradient(180deg, #05070c 0%, #0b111d 100%)',
  'components-system-panel-bg': 'rgba(15, 23, 42, 0.46)',
  'components-system-panel-border': 'rgba(148, 163, 184, 0.22)',
  'components-system-panel-shadow': '0 24px 40px -24px rgba(2, 6, 23, 0.85), 0 1px 2px rgba(2, 6, 23, 0.8)',
  'components-system-header-title': '#f8fafc',
  'components-system-header-description': '#94a3b8',
  'components-system-version-tag-bg': 'rgba(30, 41, 59, 0.7)',
  'components-system-version-tag-border': 'rgba(148, 163, 184, 0.28)',
  'components-system-version-tag-label': '#94a3b8',
  'components-system-version-tag-value': '#e2e8f0',
  'components-system-section-title': '#cbd5e1',
  'components-system-section-divider': 'rgba(148, 163, 184, 0.28)',
  'components-system-empty-bg': 'rgba(15, 23, 42, 0.55)',
  'components-system-empty-border': 'rgba(148, 163, 184, 0.22)',

  'components-system-health-ok-bg': 'rgba(34, 197, 94, 0.18)',
  'components-system-health-ok-border': 'rgba(74, 222, 128, 0.45)',
  'components-system-health-ok-text': '#86efac',
  'components-system-health-warning-bg': 'rgba(245, 158, 11, 0.18)',
  'components-system-health-warning-border': 'rgba(251, 191, 36, 0.45)',
  'components-system-health-warning-text': '#fcd34d',
  'components-system-health-error-bg': 'rgba(239, 68, 68, 0.18)',
  'components-system-health-error-border': 'rgba(248, 113, 113, 0.45)',
  'components-system-health-error-text': '#fca5a5',

  'components-system-status-card-bg': 'rgba(15, 23, 42, 0.58)',
  'components-system-status-card-border': 'rgba(148, 163, 184, 0.2)',
  'components-system-status-card-border-hover': 'rgba(148, 163, 184, 0.4)',
  'components-system-status-card-shadow': '0 14px 28px -20px rgba(2, 6, 23, 0.9), 0 1px 2px rgba(2, 6, 23, 0.8)',
  'components-system-status-ok-bg': 'rgba(34, 197, 94, 0.16)',
  'components-system-status-ok-border': 'rgba(74, 222, 128, 0.42)',
  'components-system-status-ok-text': '#86efac',
  'components-system-status-warning-bg': 'rgba(245, 158, 11, 0.16)',
  'components-system-status-warning-border': 'rgba(251, 191, 36, 0.42)',
  'components-system-status-warning-text': '#fcd34d',
  'components-system-status-error-bg': 'rgba(239, 68, 68, 0.18)',
  'components-system-status-error-border': 'rgba(248, 113, 113, 0.42)',
  'components-system-status-error-text': '#fca5a5',

  'components-system-chart-grid': 'rgba(148, 163, 184, 0.25)',
  'components-system-chart-axis': '#94a3b8',
  'components-system-chart-tooltip-bg': '#0f172a',
  'components-system-chart-tooltip-border': 'rgba(148, 163, 184, 0.35)',
  'components-system-chart-tooltip-text': '#e2e8f0',
  'components-system-chart-tooltip-muted': '#94a3b8',
  'components-system-chart-done': '#4ade80',
  'components-system-chart-done-soft': 'rgba(74, 222, 128, 0.2)',
  'components-system-chart-failed': '#fb7185',
  'components-system-chart-failed-soft': 'rgba(251, 113, 133, 0.2)',
  'components-system-chart-pending': '#fbbf24',
  'components-system-chart-pending-soft': 'rgba(251, 191, 36, 0.2)',
  'components-system-chart-lag': '#94a3b8',
  'components-system-chart-info-pill-bg': 'rgba(51, 65, 85, 0.65)',
  'components-system-chart-info-pill-text': '#cbd5e1',
}
