...
export const lightTokens: DesignTokens = {
  ...
  'components-main-workbench-shadow': '0 18px 36px -24px rgba(15, 23, 42, 0.28)',
  ...
  'components-system-panel-shadow': '0 10px 25px -15px rgba(0, 0, 0, 0.12), 0 1px 2px rgba(0, 0, 0, 0.06)',
  ...
  'components-system-status-card-shadow': '0 1px 3px 0 rgba(0, 0, 0, 0.1), 0 1px 2px -1px rgba(0, 0, 0, 0.1)',
...
export const darkTokens: DesignTokens = {
  ...
  'components-app-shell-surface': '#111214',
  'components-app-shell-border': 'rgba(255, 255, 255, 0.08)',
  'components-app-shell-shadow': '0 24px 48px -24px rgba(0, 0, 0, 0.6)',
  'components-main-workbench-bg': '#0f1012',
  'components-main-workbench-surface': '#121416',
  'components-main-workbench-border': 'rgba(255, 255, 255, 0.08)',
  'components-main-workbench-shadow': '0 24px 48px -24px rgba(0, 0, 0, 0.65)',
  'components-page-header-bg': 'rgba(18, 20, 22, 0.96)',
  'components-page-header-border': 'rgba(255, 255, 255, 0.08)',
  'components-page-header-title': '#ffffff',
  'components-page-header-description': '#a1a1aa',
  'components-page-toolbar-bg': 'rgba(18, 20, 22, 0.94)',
  'components-page-toolbar-border': 'rgba(255, 255, 255, 0.08)',
  'components-page-toolbar-text': '#a1a1aa',
  'components-page-state-bg': '#18181b',
  'components-page-state-border': 'rgba(255, 255, 255, 0.08)',
  'components-page-state-icon-bg': 'rgba(255, 255, 255, 0.06)',
  'components-page-state-icon': '#33D4CB',
  'components-page-state-title': '#ffffff',
  'components-page-state-description': '#a1a1aa',
  'components-settings-rail-bg': '#121212',
  'components-settings-rail-border': 'rgba(255, 255, 255, 0.08)',
  ...
  'components-console-bg': '#0a0a0a',
  'components-console-surface': '#121212',
  'components-console-border': 'rgba(255, 255, 255, 0.08)',
  'components-workspace-bg': '#0b0c0f',
  'components-workspace-surface': '#121212',
  'components-workspace-border': 'rgba(255, 255, 255, 0.08)',
  'components-studio-bg': '#090b10',
  'components-studio-surface': '#121418',
  'components-studio-border': 'rgba(255, 255, 255, 0.08)',
  'components-split-pane-bg': '#0a0c10',
  'components-split-pane-surface': '#121212',
  'components-split-pane-border': 'rgba(255, 255, 255, 0.08)',
  ...
  'components-system-panel-shadow': '0 20px 25px -12px rgba(0, 0, 0, 0.45), 0 1px 2px rgba(0, 0, 0, 0.35)',
  ...
  'components-system-status-card-shadow': '0 1px 3px 0 rgba(0, 0, 0, 0.2), 0 1px 2px -1px rgba(0, 0, 0, 0.15)',
