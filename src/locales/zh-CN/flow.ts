export default {
  flow: {
    ...
    codeRunInspector: '代码运行检查器',
    codeRunInspectorTip: '查看本次运行的业务值、类型元数据、日志和原始负载。',
    codeContractError: '返回类型不匹配',
    codeExecutionError: '执行错误',
    applyActualCodeOutputType: '使用实际类型：{{type}}',
    codeOutputTypeUpdated: '输出类型已更新为 {{type}}',
    businessOutput: '业务输出',
    businessOutputTip: 'main() 返回的值。',
    businessOutputValue: '业务输出值',
    expectedType: '期望类型',
    actualType: '实际类型',
    resultStatus: '状态',
    succeeded: '成功',
    ...
    rawResult: '原始结果',
    attachments: '附件',
    codeAttachmentsTip: '本次代码运行生成的文件。',
    rawComponentOutput: '组件原始输出',
    noSystemOutputs: '暂无系统输出',
    codeReturnValue: '返回值',
    codeReturnValueTip:
      '从 main() 暴露一个业务输出；系统输出会继续用于日志和诊断。',
    codeSingleOutputBadge: '单输出',
    codeInvalidOutputName: '请使用非空名称，且不要包含点号或系统保留字段。',
    outputType: '类型',
    codeOutputContract: '输出契约',
    codeOutputContractTip:
      '下游节点使用业务值；系统输出用于渲染、类型检查、原始结果和附件排查。',
    systemOutputs: '系统输出',
    systemOutputsTip: '运行时元数据，包括日志、类型检查、原始结果和附件。',
    codeMainReturnTip:
      '从 main() 返回可 JSON 序列化的值，它会作为下面唯一的业务输出暴露。',
    codeEditorTitle: '代码编辑器',
    codeEditorDescription: '在专注工作区中编辑当前 Code 节点脚本。',
    codeEditorAriaLabel: '{{language}} 代码编辑器',
    codeEditorLoading: '正在加载代码编辑器…',
    codeEditorExpand: '展开代码编辑器',
    codeEditorCollapse: '返回节点配置',
    codeEditorLineCount: '行数：{{count}}',
    codeEditorEscapeHint: '返回节点配置',
    codeTemplate: '模板',
    codeTemplateTip: '模板会同时更新代码内容和声明的返回类型。',
    codeTemplateStringResult: '返回字符串',
    codeTemplateObjectResult: '返回对象',
    codeTemplateCsvArtifact: '生成产物',
    codeParameterPreview: '参数预览',
    codeJsRuntimeArgsHint: 'JavaScript 以 main(args) 接收此对象。',
    codePythonRuntimeArgsHint: 'Python 以 main(**args) 接收这些字段。',
    codeReturnTypeContractHint:
      'main() 的返回值必须匹配 {{type}}。使用上方模板选择器可同时切换代码和输出类型。',
    codeRuntimeShape: '运行时结构',
    codeRuntimeShapeTip: '下游节点看到的契约与运行时校验的契约一致。',
    mergePath: '合并路径',
    mergePathTip: '将变量后的点路径合并为一个引用，例如 {node@result}.answer。',
    autoPlay: '自动播放',
...
以上就是你需要总结的内容。`,
    ...
    htmlReportImport: '导入配置',
    htmlReportExport: '导出配置',
    htmlReportImportOk: '已导入编排',
    htmlReportImportError: '导入失败:文件格式不正确',
    htmlReportRunTitle: '试运行',
    htmlReportRunDesc: '用样本输入填充模板,预览一份真实报告。',
    htmlReportRunSource: '样本源料',
    htmlReportRunSourcePlaceholder: '粘贴模型据以填充的样本上游文本…',
    htmlReportRunVariables: '变量样本值',
    htmlReportRunProgress: '正在填充第 {{current}}/{{total}} 节…',
    htmlReportRunExpanding: '正在展开第 {{current}}/{{total}} 个生成区…',
    htmlReportRunStarting: '准备中…',
    htmlReportRunError: '试运行失败',
    htmlReportRunPartial: '有 {{count}} 节未能填充',
    ...
    htmlReportBlockOpenRegion: '生成区',
    htmlReportOpenRegionBrief: '生成提示',
    htmlReportOpenRegionBriefPlaceholder:
      '描述这块讲报告中哪部分内容、用什么组件…',
    htmlReportOpenRegionHelp:
      '模型会在运行时按你的提示生成这块内容,例如「用 3 个图表,类型你定」或「先一段文字,再一个饼图」。',
    ...
    htmlReportTitleLlmPlaceholder: '描述标题应如何生成',
    htmlReportEyebrow: '导语小标',
    ...
    htmlReportHeaderArtBusiness: '展业发展',
    htmlReportHeaderArtGovernment: '政务治理',
    htmlReportHeaderArtTourism: '文旅城市',
    htmlReportHeaderArtEcology: '生态环境',
    htmlReportHeaderArtCampus: '高校 · 默认',
    htmlReportHeaderArtCampusTalent: '高校 · 人才培养',
    htmlReportHeaderArtCampusGrowth: '高校 · 发展',
    htmlReportHeaderArtCampusTeaching: '高校 · 教学',
    htmlReportHeaderArtCampusData: '高校 · 数据治理',
    ...
    htmlReportEnumModelHint: '由模型从以下选项中选择：',
    htmlReportEnumLlmPlaceholder: '可选：说明何时用哪个',
    ...
    htmlReportIconAuto: '自动',
    htmlReportIconUsers: '人群',
    htmlReportIconMoney: '金额',
    htmlReportIconTrend: '增长',
    htmlReportIconThumbsUp: '好评',
    htmlReportIconBuilding: '建筑',
    htmlReportIconCalendar: '日历',
    htmlReportIconClock: '时长',
    htmlReportIconFlag: '里程碑',
    htmlReportIconChart: '图表',
    htmlReportIconStar: '评级',
    htmlReportIconTarget: '目标',
    htmlReportIconLayers: '规模',
    htmlReportIconGlobe: '全球',
    htmlReportIconCheck: '达标',
...
[在此处插入文本]`,
    ...
    pipelineResult: {
      title: 'Pipeline 运行结果',
      description:
        '按 chunk 审阅本次 Pipeline 输出，快速检查文本、图片、表格与向量化状态。',
      fallbackAgentTitle: 'Pipeline',
      backPipeline: '返回 Pipeline',
      downloadJson: '下载 JSON',
      downloadFileBaseName: 'pipeline-output',
      missingTitle: '缺少 Pipeline 结果上下文',
      missingDescription:
        '当前链接缺少运行结果所需的信息，无法读取本次 Pipeline 输出。',
      backToAgents: '返回智能体列表',
      loadingTitle: '正在读取 Pipeline trace',
      loadingDescription: '根据 agent_id 与 message_id 获取本次运行结果。',
      loadFailedTitle: '读取 Pipeline 结果失败',
      loadFailedDescription:
        '当前 trace 暂时不可用，请重试或返回 Pipeline 检查日志。',
      retry: '重试',
      runSummaryTitle: '本次运行',
      runSummaryDescription:
        '快速核对运行来源、chunk 类型分布和向量化状态，再进入下方审阅结果。',
      contextTitle: '运行上下文',
      overviewTitle: '结果概览',
      outputTitle: 'END 节点输出',
      emptyTitle: '暂无 END 节点输出',
      emptyDescription:
        '当前运行还没有可展示的结果。请返回 Pipeline 检查运行日志，或重新运行后再查看。',
      searchPlaceholder: '搜索文本、标题、序号或图片 ID',
      searchLabel: '搜索 Pipeline 输出 chunk',
      typeFilter: '按 chunk 类型过滤',
      viewModeLabel: '结果视图',
      chunksTab: 'Chunk 审阅',
      jsonTab: '精简 JSON',
      filteredCount: '已显示 {{shown}} / {{total}} 个 chunk',
      noChunksTitle: '没有匹配的 chunk',
      noChunksDescription: '调整搜索关键词或类型过滤后再试。',
      detailTitle: 'Chunk 详情',
      noSelectionTitle: '未选择 chunk',
      noSelectionDescription: '从左侧列表选择一个 chunk 查看字段细节。',
      compactJsonHint:
        '页面会折叠向量数组，仅展示维度摘要；下载 JSON 会保留完整原始输出。',
      chunkOrder: '#{{order}}',
      textLength: '{{value}} 字符',
      emptyChunkText:
        '该 chunk 没有文本内容，可能只包含图片、表格或结构化字段。',
      pagesBadge: '页码 {{pages}}',
      vectorBadge: '{{dimensions}} 维向量',
      imageBadge: '图片引用',
      chunkTextLabel: '文本内容',
      vectorSummaryLabel: '向量摘要',
      metadataTitle: '结构化字段',
      rawChunkLabel: '精简字段 JSON',
      vectorDimensions: '{{dimensions}} 维',
      emptyValue: '-',
      metadata: {
        agent: 'Agent',
        agentId: 'Agent ID',
      ...
      stats: {
        ...
        textChunks: '文本 chunk',
        mediaChunks: '图表 chunk',
        vectorizedChunks: '已向量化',
        tableChunks: '表格 chunk',
        imageChunks: '图片 chunk',
        otherChunks: '其他 chunk',
        textCharacters: '文本字符数',
      },
      types: {
        all: '全部类型',
        text: '文本',
